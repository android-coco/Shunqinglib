 ...
 * 编辑定位时段
 */
public class DwSdEditActivity extends BaseActiciy implements CompoundButton.OnCheckedChangeListener
{
    ...
    public void initData()
    {
        ...
        {
            rid = dwSdModel.getId();
            stime_1.setText(dwSdModel.getStartHour());
            stime_2.setText(dwSdModel.getStartMinute());
            etime_1.setText(dwSdModel.getEndHour());
            etime_2.setText(dwSdModel.getEndMinute());
            times.setText(dwSdModel.getTime());
            //timingpostion_name.setText(dwSdModel.name);
            byte[] weeks = dwSdModel.getWeek().getBytes();
            week = dwSdModel.getWeek();
